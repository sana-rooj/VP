        ...
        class studentProfile
        {
            public void createfile(string path)
            {
                ...
                using (StreamWriter obj = new StreamWriter(path))
                {
                    ...
                    obj.WriteLine("mishal 01-131152-016 bsce 6 3.8 absent");
                        ...
                        case "1":
                            {
                                ...
                                Console.WriteLine("please enter the first name, enroll, department (bs--),semester no,cgpa,attendance status(present/absent) in the written format");
                        ...
                        case "2":
                            {
                                ...
                                else if (searchChoice == "3")
                                {
                                    ...
                                    obj1.checkEnroll(semester, path);
                                }
                                else
